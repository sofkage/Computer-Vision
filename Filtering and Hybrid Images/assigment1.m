...
%image1 = im2single(imread('pair2_HeathLedger.png'));
%image2 = im2single(imread('pair2_joker.png'));
...
low_frequencies_2 = my_imfilter(image2, filter2);
B= imfilter(image2, filter2);
mse = immse(low_frequencies_2,B)
